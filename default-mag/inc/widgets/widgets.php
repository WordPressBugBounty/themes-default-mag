                ...
                <div class="twp-social">
                    <?php if (!empty($params['url-fb'])) { ?>
                        <span class="twp-social-icon-rounded twp-secondary-border">
                            <a href="<?php echo esc_url($params['url-fb']); ?>"><i class="fa fa-facebook"></i></a>
                        </span>
                    <?php } ?>
                    <?php if (!empty($params['url-tw'])) { ?>
                        <span class="twp-social-icon-rounded twp-secondary-border">
                            <a href="<?php echo esc_url($params['url-tw']); ?>"><i class=" fa fa-twitter"></i></a>
                        </span>
                    <?php } ?>
                    <?php if (!empty($params['url-lt'])) { ?>
                        <span class="twp-social-icon-rounded twp-secondary-border">
                            <a href="<?php echo esc_url($params['url-lt']); ?>"><i class=" fa fa-linkedin"></i></a>
                        </span>
                    <?php } ?>
                    <?php if (!empty($params['url-ig'])) { ?>
                        <span class="twp-social-icon-rounded twp-secondary-border">
                            <a href="<?php echo esc_url($params['url-ig']); ?>"><i class=" fa fa-instagram"></i></a>
                        </span>
                    <?php } ?>
                </div>
            </div>
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'comments_heading' => array(
                    'label' => __('More Comments', 'default-mag'),
                    'type' => 'heading',
                ),
                    ...
                    <div class="section-head">
                        <ul class="nav nav-tabs twp-tab" role="tablist">
                            <li role="presentation" class="tab tab-popular">
                                <a href="#<?php echo esc_attr($tab_id); ?>-popular" class="active" aria-controls="<?php esc_attr_e('Popular', 'default-mag'); ?>" role="tab" data-toggle="tab">
                    ...
                    <li class="twp-post twp-post-style-1">
                        <div class="twp-image-section twp-image-70">
                            ...
                            <?php if (has_post_thumbnail($post->ID)) { ?>
                                ...
                                <?php if (!empty($image)): ?>
                                    <div class="twp-image data-bg" data-background="<?php echo esc_url($image[0]); ?>"></div>
                                <?php endif; ?>
                            <?php } ?>
                        </div>
                    ...
                    <li class="twp-post twp-post-style-1">
                        <figure class="twp-image-section">
                            ...
                            <?php if (!empty($comment_author_url)): ?>
                                <a class="data-bg data-bg-sm bg-image"
                                   href="<?php echo esc_url($comment_author_url); ?>"><?php echo get_avatar($comment, 65);
                                    ?></a>
                            <?php else : ?>
                            ...
                            <div class="twp-block-post twp-post twp-post-style-2">
                                <div class="twp-image-section twp-image-with-content twp-image-hover-effect">
                                    ...
                                    <div class="twp-desc twp-overlay twp-overlay-bg-black twp-w-100">
                                        ...
                                        <h3 class="twp-post-title"><a class="twp-white-anchor-text"
...
if (!class_exists('TWP_Homepage_widget_style_2')) :
    ...
    class TWP_Homepage_widget_style_2 extends Default_Mag_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            parent::__construct('default-mag-fullwidth-widget-style-2', __('DM :- Full-Width Homepage Widget Style 2', 'default-mag'), $opts, array(), $fields);
        }
