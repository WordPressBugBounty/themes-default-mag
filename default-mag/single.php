			...
			if (!empty( $next_post )): ?>
				<div class="twp-single-next-post twp-secondary-font">
					...
					<?php
						...
						if ($post_categories) {
							$output = '<div class="twp-categories twp-primary-categories">';
							foreach ($post_categories as $post_category) {
								$output .= '<a class="default-mag-categories twp-primary-anchor-text--" href="' . esc_url(get_category_link($post_category)) . '" alt="' . esc_attr(sprintf(__('View all posts in %s', 'default-mag'), $post_category->name)) . '"> 
